 ...
 * [AddDonorFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [AddDonorFragment.newInstance] factory method to
...
class AddDonorFragment : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): AddDonorFragment {
            val fragment = AddDonorFragment()
            val args = Bundle()
